# Earnings Analysis: LITE — Q4 2026

*Analysis date: 2026-09-14 | Report date: 2026-08-11 | Price: $835.03*

## Summary

| Metric | Value |
|--------|-------|
| Weighted Fair Value | **$879.2** |
| Upside from Current | +5.29% |
| Consensus PT | $1149.38 |
| Verdict | Below consensus ($1149.38) by 23.51% — more cautious |

## ⚠️ Income Quality Adjustment

Headline EPS $-84.65 includes one-time items:

- **Convertible debt equitization and extinguishment non-cash charge**: $7.76B (non-operating) — Non-cash GAAP accounting charge of $7.76B resulting from rapid stock price appreciation upon convertible notes conversion/extinguishment. Core operational Non-GAAP EPS was $3.23, beating consensus of $2.97.

Operating EPS (adjusted): **$3.23**

## Earnings Breakdown

| Metric | Actual | Estimate | Beat/Miss |
|--------|--------|----------|-----------|
| Revenue | $1.0063B | $0.9877B | ✅ Beat |
| Op. Income | $0.3683B | — | +215% YoY |
| EPS (operating) | $3.23 | $2.97 | ✅ Beat |
...
|---|----------|------|-------|---------|--------|
| 1 | Acceleration of 1.6T Transceiver Volume Shipments to Hyperscalers | 📈 growth | 75% | near-term | Tier-1 hyperscalers began qualifying and deploying 1.6T transceivers in Q4 FY26, with management confirming contracted demand running ahead of factory capacity through CY2027. |
| 2 | Optical Circuit Switching (OCS) Adoption in Megawatt AI Datacenters | 📈 growth | 65% | medium-term | Multiple hyperscalers are adopting OCS to eliminate power-hungry electronic spine switches, with Lumentum guiding OCS revenues toward triple-digit millions in FY2027. |
| 3 | Monetary Easing Cycle Driving Multiple Expansion in Semiconductor Capital | 📈 growth | 60% | medium-term | Fed rate cut path reduces discount rates and cost of capital for capital-intensive hyperscaler data center projects. |
| 4 | EML Laser Diode & Cleanroom Capacity Bottlenecks | 📉 risk | 40% | near-term | In-house Indium Phosphide (InP) wafer fab and cleanroom packaging capacity are running near 100% utilization, creating lead-time risks. |
| 5 | Hyperscaler Datacenter Buildout Digestion or Pause | 📉 risk | 35% | medium-term | Historically, major hyperscaler infrastructure buildouts (e.g. 2018-2019, 2022) undergo 2-4 quarter pauses once initial cluster capacity is deployed. |
...
- **Stressed Revenue:** $5.84B
- **Stressed Gross Profit:** $3.01B
- **Stressed Operating Income:** $2.34B
- **Stressed Net Income:** $1.95B
- **Downside to Panic Floor:** -37.52%
- **Market Priced-In Multiple:** 38.41x

| Regime | Multiple | Target Price | Delta vs Current |
|--------|----------|--------------|------------------|
| 🐂 Bull | 48x | $1043.52 | +24.97% |
| ⚖️ Base | 40x | $869.6 | +4.14% |
| 🚨 Panic | 24x | $521.76 | -37.52% |
